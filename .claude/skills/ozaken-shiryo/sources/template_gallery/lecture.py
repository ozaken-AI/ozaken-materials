...
def build(figures, parts, catalog, blocks, categories, base_style, keynav, assets, mini):
    ...
    styles=(assets.parent/'lecture_cover/motion.css').read_text()+'\n'+styles
...
<main><div class="tl-hero" data-ambient-zone>{cover_air()}<div class="tl-hero-copy"><span class="tl-eyebrow">OZAKEN TEMPLATE COLLECTION / LECTURE EDITION</span><h1><span><b>伝わる資料に</b></span><span><b><em>動きを</em></b></span></h1><p>言葉も 数字も 物語も<br>一枚で届く 動きで心に残る</p><a href="#figures" class="tl-hero-link">テンプレートを見る <span>↓</span></a></div><div class="tl-hero-art" aria-hidden="true">{curtain()}<span class="tl-hero-art-caption">WORDS INTO EXPERIENCE</span></div><div class="tl-hero-bottom"><span>言葉が届く 理解がつながる</span><span>34 FIGURES ／ 33 BUILDING BLOCKS</span></div></div>
