...
def parts():
    return {
        'cover': '<div class="nx-cover" data-ambient-zone>'+curtain()+'<span class="nx-overline">A QUESTION WORTH ASKING</span><h4><span>問いを、</span><span>未来につなぐ。</span></h4><p>言葉から始まる、次の一歩。</p></div>',
