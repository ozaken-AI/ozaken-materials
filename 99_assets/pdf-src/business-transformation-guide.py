...
AX資料（01_concept/ax-article.html）のプロセス論を土台にする。
...
page('Section 10 ─ Adoption',
     ...
     ], '', '', dark=True, center='定着ループ', uid='bpt8'),
